...
public class LStarDFAAdapter<I> extends LStarBaseAdapter<I> implements ProceduralLearner<I> {

    public LStarDFAAdapter(Alphabet<I> alphabet, MembershipOracle<I, Boolean> oracle) {
