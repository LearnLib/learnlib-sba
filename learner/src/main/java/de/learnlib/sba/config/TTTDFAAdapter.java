...
public class TTTDFAAdapter<I> extends TTTAdapter<I> implements ProceduralLearner<I> {

    public TTTDFAAdapter(Alphabet<I> alphabet, MembershipOracle<I, Boolean> oracle) {
